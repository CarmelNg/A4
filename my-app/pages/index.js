...
* 
*  Name: _CARMEL CHEUMADJEU NGUELEBEK__ Student ID: __130451214___ Date: ___01/03/2023_
*
********************************************************************************/ 
...
export default function Home() {
  return (
    <>
      <Image className="fluid rounded" width="100%" src="https://upload.wikimedia.org/wikipedia/commons/3/30/Metropolitan_Museum_of_Art_%28The_Met%29_-_Central_Park%2C_NYC.jpg"/>
      <br/>
      <br/>
      <Row>
        <Col md={6}>
